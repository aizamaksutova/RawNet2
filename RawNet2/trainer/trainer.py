...
from RawNet2.base.base_trainer import BaseTrainer
from RawNet2.logger.utils import plot_spectrogram_to_buf
from RawNet2.utils import inf_loop, MetricTracker
    ...
    def _log_predictions(self, audio, pred, target, examples_to_log=3, **kwargs):
        ...
        for i in range(examples_to_log):
            ...
            while tries_cnt < 30 and not ((i == 0 and target[idx] == 1) or (i > 0 and target[idx] == 0)):
                ...
                tries_cnt += 1
            rows[i] = {
                "audio": self.writer.wandb.Audio(audio[idx].cpu().squeeze().numpy(), sample_rate=16000),
